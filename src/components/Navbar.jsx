        ...
        <>
            <nav className="d-block navbar navbar-expand-sm navbar-dark bg-dark p-3 fixed-top">
                <div className="container-fluid">
                    <a href='/' className='navbar-brand'><img src={logo} alt="" height={60} width={60} /></a>
                        ...
                        <ul className="navbar-nav ms-auto d-flex align-items-center gap-4">
                            ...
                            <li className="nav-item">
                                <button
                                    ...
                                    title="Toggle theme"
                                >
                                    {nightMode ? <BsSun className='BTn_Sun' /> : <BsMoon className='BTn_Moon' />}
                                </button>
                            </li>

                            <li className="nav-item">
                                <GrSettingsOption className="Setting_icon text-center justify-content-center cursor-pointer" onClick={toggleSidebar} />
                            </li>
                            ...
                            <div className={`custom-offcanvas ${isOpen ? 'show' : ''}`}>
                                <div className="offcanvas-header p-3">
                                    ...
                                    <CgClose className="CloSe_BTn cursor-pointer" onClick={closeSidebar} />
                                </div>
                                ...
                                <div className="text-white p-3">
                                    <div className="setting-row">
                                        ...
                                        <label className="switch">
                                            <input type="checkbox" checked={digitalFont} onChange={() => setDigitalFont(!digitalFont)} />
                                    ...
                                    <div className="setting-row">
                                        ...
                                        <label className="switch">
                                            <input type="checkbox" checked={is12Hour} onChange={() => setIs12Hour(!is12Hour)} />
                                            <span className="slider"></span>
                                        </label>
                                    </div>
                                    ...
                                    <button className="btn btn-primary w-100 mt-4" onClick={applySettings}>
                                        OK
                                    </button>
                                </div>
                            </div>
