      ...
      <div className="container-fluid">
        <div className="row Home_Main mb-4">
          <div className="col-md-12 BTN_Timer2 text-start bg-translate border">
            ...
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 10, 5))}>
              10:05 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 10, 10))}>
              10:10 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 10, 15))}>
              10:15 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 10, 20))}>
              10:20 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 10, 25))}>
              10:25 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 10, 30))}>
              10:30 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 10, 35))}>
              10:35 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 10, 40))}>
              10:40 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 10, 45))}>
              10:45 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 10, 50))}>
              10:50 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 10, 55))}>
              10:55 AM
            </button>
            <br />
            <br />
