      ...
      <div className="container-fluid">
        <div className="row Home_Main mb-4">
          <div className="col-md-12 BTN_Timer2 text-start bg-translate border">
            ...
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 8, 5))}>
              8:05 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 8, 10))}>
              8:10 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 8, 15))}>
              8:15 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 8, 20))}>
              8:20 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 8, 25))}>
              8:25 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 8, 30))}>
              8:30 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 8, 35))}>
              8:35 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 8, 40))}>
              8:40 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 8, 45))}>
              8:45 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 8, 50))}>
              8:50 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 8, 55))}>
              8:55 AM
            </button>
            <br />
            <br />
