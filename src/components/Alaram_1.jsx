      ...
      <div className="container-fluid">
        <div className="row Home_Main mb-4">
          <div className="col-md-12 BTN_Timer2 text-start bg-translate border">
            ...
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 1, 5))}>
              1:05 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 1, 10))}>
              1:10 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 1, 15))}>
              1:15 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 1, 20))}>
              1:20 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 1, 25))}>
              1:25 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 1, 30))}>
              1:30 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 1, 35))}>
              1:35 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 1, 40))}>
              1:40 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 1, 45))}>
              1:45 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 1, 50))}>
              1:50 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 1, 55))}>
              1:55 AM
            </button>
            <br />
            <br />
