      ...
      <div className="container-fluid">
        <div className="row Home_Main mb-4">
          <div className="col-md-12 BTN_Timer2 text-start bg-translate border">
            ...
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 6, 5))}>
              6:05 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 6, 10))}>
              6:10 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 6, 15))}>
              6:15 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 6, 20))}>
              6:20 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 6, 25))}>
              6:25 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 6, 30))}>
              6:30 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 6, 35))}>
              6:35 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 6, 40))}>
              6:40 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 6, 45))}>
              6:45 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 6, 50))}>
              6:50 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 6, 55))}>
              6:55 AM
            </button>
            <br />
            <br />
