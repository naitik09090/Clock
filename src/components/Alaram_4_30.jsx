...
const Set_4 = () => {
  ...
  const [title, setTitle] = useState("Alarm 4:30 AM");
  ...
  return (
    <div className="container-fluid">
      <div className="row Home_Main flex flex-column justify-content-center align-items-center vh-100 bg-translate mb-3">
      ...
      <div className="container-fluid">
        <div className="row Home_Main mb-4">
          <div className="col-md-12 BTN_Timer2 text-start bg-translate border">
            ...
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 4, 5))}>
              4:05 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 4, 10))}>
              4:10 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 4, 15))}>
              4:15 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 4, 20))}>
              4:20 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 4, 25))}>
              4:25 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 4, 30))}>
              4:30 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 4, 35))}>
              4:35 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 4, 40))}>
              4:40 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 4, 45))}>
              4:45 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 4, 50))}>
              4:50 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 4, 55))}>
              4:55 AM
            </button>
            <br />
            <br />
