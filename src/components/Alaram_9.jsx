      ...
      <div className="container-fluid">
        <div className="row Home_Main mb-4">
          <div className="col-md-12 BTN_Timer2 text-start bg-translate border">
            ...
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 9, 5))}>
              9:05 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 9, 10))}>
              9:10 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 9, 15))}>
              9:15 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 9, 20))}>
              9:20 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 9, 25))}>
              9:25 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 9, 30))}>
              9:30 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 9, 35))}>
              9:35 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 9, 40))}>
              9:40 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 9, 45))}>
              9:45 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 9, 50))}>
              9:50 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 9, 55))}>
              9:55 AM
            </button>
            <br />
            <br />
