      ...
      <div className="container-fluid">
        <div className="row Home_Main mb-4">
          <div className="col-md-12 BTN_Timer2 text-start bg-translate border">
            ...
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 11, 5))}>
              11:05 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 11, 10))}>
              11:10 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 11, 15))}>
              11:15 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 11, 20))}>
              11:20 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 11, 25))}>
              11:25 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 11, 30))}>
              11:30 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 11, 35))}>
              11:35 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 11, 40))}>
              11:40 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 11, 45))}>
              11:45 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 11, 50))}>
              11:50 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 11, 55))}>
              11:55 AM
            </button>
            <br />
            <br />
