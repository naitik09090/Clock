      ...
      <div className="container-fluid">
        <div className="row Home_Main mb-4">
          <div className="col-md-12 BTN_Timer2 text-start bg-translate border">
            ...
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 2, 5))}>
              2:05 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 2, 10))}>
              2:10 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 2, 15))}>
              2:15 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 2, 20))}>
              2:20 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 2, 25))}>
              2:25 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 2, 30))}>
              2:30 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 2, 35))}>
              2:35 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 2, 40))}>
              2:40 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 2, 45))}>
              2:45 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 2, 50))}>
              2:50 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 2, 55))}>
              2:55 AM
            </button>
            <br />
            <br />
