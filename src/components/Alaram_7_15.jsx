      ...
      <div className="container-fluid">
        <div className="row Home_Main mb-4">
          <div className="col-md-12 BTN_Timer2 text-start bg-translate border">
            ...
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 7, 5))}>
              7:05 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 7, 10))}>
              7:10 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 7, 15))}>
              7:15 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 7, 20))}>
              7:20 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 7, 25))}>
              7:25 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 7, 30))}>
              7:30 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 7, 35))}>
              7:35 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 7, 40))}>
              7:40 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 7, 45))}>
              7:45 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 7, 50))}>
              7:50 AM
            </button>
            <button onClick={() => onAlaramChag(new Date(1970, 1, 1, 7, 55))}>
              7:55 AM
            </button>
            <br />
            <br />
