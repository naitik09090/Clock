        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-12-1-36'>
                            <button>12:36 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-37'>
                            <button>12:37 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-38'>
                            <button>12:38 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-39'>
                            <button>12:39 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-40'>
                            <button>12:40 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-41'>
                            <button>12:41 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-42'>
                            <button>12:42 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-43'>
                            <button>12:43 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-44'>
                            <button>12:44 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-45'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 12:37 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 12:37 AM. Set my alarm for 12:37 AM. This free alarm clock will wake you up in time.</p>
