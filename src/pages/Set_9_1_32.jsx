        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-9-1-36'>
                            <button>9:36 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-37'>
                            <button>9:37 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-38'>
                            <button>9:38 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-39'>
                            <button>9:39 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-40'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 9:32 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 9:32 AM. Set my alarm for 9:32 AM. This free alarm clock will wake you up in time.</p>
