        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-8-1-28'>
                            <button>8:28 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-29'>
                            <button>8:29 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-30'>
                            <button>8:30 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-31'>
                            <button>8:31 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-32'>
                            <button>8:32 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-33'>
                            <button>8:33 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-34'>
                            <button>8:34 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-35'>
                            <button>8:35 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-36'>
                            <button>8:36 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-37'>
                            <button>8:37 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-38'>
                            <button>8:38 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-39'>
                            <button>8:39 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 8:29 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 8:29 AM. Set my alarm for 8:29 AM. This free alarm clock will wake you up in time.</p>
