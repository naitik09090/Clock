        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-9-1-41'>
                            <button>9:41 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-42'>
                            <button>9:42 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-43'>
                            <button>9:43 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-44'>
                            <button>9:44 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-45'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 9:42 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 9:42 AM. Set my alarm for 9:42 AM. This free alarm clock will wake you up in time.</p>
