        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-7-1-6'>
                            <button>7:06 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-7'>
                            <button>7:07 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-8'>
                            <button>7:08 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-9'>
                            <button>7:09 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-10'>
                            <button>7:10 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-11'>
                            <button>7:11 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-12'>
                            <button>7:12 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-13'>
                            <button>7:13 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-14'>
                            <button>7:14 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-15'>
                            <button>7:15 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-16'>
                            <button>7:16 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-17'>
                            <button>7:17 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 7:07 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 7:07 AM. Set my alarm for 7:07 AM. This free alarm clock will wake you up in time.</p>
