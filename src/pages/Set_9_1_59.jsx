        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-9-1-58'>
                            <button>9:58 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-59'>
                            <button>9:59 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 9:59 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 9:59 AM. Set my alarm for 9:59 AM. This free alarm clock will wake you up in time.</p>
