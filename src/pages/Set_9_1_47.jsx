        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-9-1-46'>
                            <button>9:46 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-47'>
                            <button>9:47 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-48'>
                            <button>9:48 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-49'>
                            <button>9:49 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-50'>
                            <button>9:50 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-51'>
                            <button>9:51 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-52'>
                            <button>9:52 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-53'>
                            <button>9:53 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-54'>
                            <button>9:54 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-55'>
                            <button>9:55 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-56'>
                            <button>9:56 AM</button>{' '}
                        </a>
                        <a href='/Set-9-1-57'>
                            <button>9:57 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 9:47 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 9:47 AM. Set my alarm for 9:47 AM. This free alarm clock will wake you up in time.</p>
