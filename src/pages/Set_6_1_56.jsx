        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-6-1-48'>
                            <button>6:48 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-49'>
                            <button>6:49 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-50'>
                            <button>6:50 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-51'>
                            <button>6:51 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-52'>
                            <button>6:52 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-53'>
                            <button>6:53 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-54'>
                            <button>6:54 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-55'>
                            <button>6:55 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-56'>
                            <button>6:56 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-57'>
                            <button>6:57 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-58'>
                            <button>6:58 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-59'>
                            <button>6:59 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
                        ...
                        <a href='/Set-6-1-5'>
                            <button>6:05 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-10'>
                            <button>6:10 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-15'>
                        ...
                        <a href='/Set-6-1-25'>
                            <button>6:25 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-30'>
                            <button>6:30 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-35'>
                            <button>6:35 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-40'>
                            <button>6:40 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-45'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 6:56 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 6:56 AM. Set my alarm for 6:56 AM. This free alarm clock will wake you up in time.</p>
