        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-10-1-31'>
                            <button>10:31 AM</button>{' '}
                        </a>
                        <a href='/Set-10-1-32'>
                            <button>10:32 AM</button>{' '}
                        </a>
                        <a href='/Set-10-1-33'>
                            <button>10:33 AM</button>{' '}
                        </a>
                        <a href='/Set-10-1-34'>
                            <button>10:34 AM</button>{' '}
                        </a>
                        <a href='/Set-10-1-35'>
                            <button>10:35 AM</button>{' '}
                        </a>
                        <a href='/Set-10-1-36'>
                            <button>10:36 AM</button>{' '}
                        </a>
                        <a href='/Set-10-1-37'>
                            <button>10:37 AM</button>{' '}
                        </a>
                        <a href='/Set-10-1-38'>
                            <button>10:38 AM</button>{' '}
                        </a>
                        <a href='/Set-10-1-39'>
                            <button>10:39 AM</button>{' '}
                        </a>
                        <a href='/Set-10-1-40'>
                            <button>10:40 AM</button>{' '}
                        </a>
                        <a href='/Set-10-1-41'>
                            <button>10:41 AM</button>{' '}
                        </a>
                        <a href='/Set-10-1-42'>
                            <button>10:42 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 10:32 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 10:32 AM. Set my alarm for 10:32 AM. This free alarm clock will wake you up in time.</p>
