        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-1-1-48'>
                            <button>1:48 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-49'>
                            <button>1:49 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-50'>
                            <button>1:50 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-51'>
                            <button>1:51 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-52'>
                            <button>1:52 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-53'>
                            <button>1:53 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-54'>
                            <button>1:54 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-55'>
                            <button>1:55 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-56'>
                            <button>1:56 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-57'>
                            <button>1:57 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-58'>
                            <button>1:58 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-59'>
                            <button>1:59 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
                        ...
                        <a href='/Set-1-1-5'>
                            <button>1:05 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-10'>
                            <button>1:10 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-15'>
                            <button>1:15 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-20'>
                            <button>1:20 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-25'>
                            <button>1:25 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-30'>
                            <button>1:30 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-35'>
                            <button>1:35 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-40'>
                            <button>1:40 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-45'>
                            <button>1:45 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-50'>
                            <button>1:50 AM</button>{' '}
                        </a>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 1:59 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 1:59 AM. Set my alarm for 1:59 AM. This free alarm clock will wake you up in time.</p>
