        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-11-1-18'>
                            <button>11:18 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-19'>
                            <button>11:19 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-20'>
                            <button>11:20 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-21'>
                            <button>11:21 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-22'>
                            <button>11:22 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-23'>
                            <button>11:23 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-24'>
                            <button>11:24 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-25'>
                            <button>11:25 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-26'>
                            <button>11:26 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-27'>
                            <button>11:27 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-28'>
                            <button>11:28 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-29'>
                            <button>11:29 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 11:19 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 11:19 AM. Set my alarm for 11:19 AM. This free alarm clock will wake you up in time.</p>
