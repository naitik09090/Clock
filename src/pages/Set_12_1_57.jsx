        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-12-1-48'>
                            <button>12:48 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-49'>
                            <button>12:49 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-50'>
                            <button>12:50 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-51'>
                            <button>12:51 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-52'>
                            <button>12:52 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-53'>
                            <button>12:53 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-54'>
                            <button>12:54 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-55'>
                            <button>12:55 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-56'>
                            <button>12:56 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-57'>
                            <button>12:57 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-58'>
                            <button>12:58 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-59'>
                            <button>12:59 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 12:57 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 12:57 AM. Set my alarm for 12:57 AM. This free alarm clock will wake you up in time.</p>
