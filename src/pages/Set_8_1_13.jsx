        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-8-1-12'>
                            <button>8:12 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-13'>
                            <button>8:13 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-14'>
                            <button>8:14 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-15'>
                            <button>8:15 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-16'>
                            <button>8:16 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-17'>
                            <button>8:17 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-18'>
                            <button>8:18 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-19'>
                            <button>8:19 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-20'>
                            <button>8:20 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-21'>
                            <button>8:21 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-22'>
                            <button>8:22 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-23'>
                            <button>8:23 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 8:13 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 8:13 AM. Set my alarm for 8:13 AM. This free alarm clock will wake you up in time.</p>
