        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-2-1-26'>
                            <button>2:26 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-27'>
                            <button>2:27 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-28'>
                            <button>2:28 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-29'>
                            <button>2:29 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-30'>
                            <button>2:30 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-31'>
                            <button>2:31 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-32'>
                            <button>2:32 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-33'>
                            <button>2:33 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 2:23 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 2:23 AM. Set my alarm for 2:23 AM. This free alarm clock will wake you up in time.</p>
