        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-2-1-41'>
                            <button>2:41 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-42'>
                            <button>2:42 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-43'>
                            <button>2:43 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-44'>
                            <button>2:44 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-45'>
                            <button>2:45 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-46'>
                            <button>2:46 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-47'>
                            <button>2:47 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-48'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 2:42 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 2:42 AM. Set my alarm for 2:42 AM. This free alarm clock will wake you up in time.</p>
