        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-6-1-11'>
                            <button>6:11 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-12'>
                            <button>6:12 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-13'>
                            <button>6:13 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-14'>
                            <button>6:14 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-15'>
                            <button>6:15 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-16'>
                            <button>6:16 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-17'>
                            <button>6:17 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-18'>
                            <button>6:18 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-19'>
                            <button>6:19 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-20'>
                            <button>6:20 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-21'>
                            <button>6:21 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-22'>
                            <button>6:22 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
                        ...
                        <a href='/Set-7-1-5'>
                            <button>7:05 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-10'>
                            <button>7:10 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-15'>
                            <button>7:15 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-20'>
                            <button>7:20 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-25'>
                            <button>7:25 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-30'>
                            <button>7:30 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-35'>
                            <button>7:35 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-40'>
                            <button>7:40 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-45'>
                            <button>7:45 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-50'>
                            <button>7:50 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-55'>
                            <button>7:55 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 6:12 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 6:12 AM. Set my alarm for 6:12 AM. This free alarm clock will wake you up in time.</p>
