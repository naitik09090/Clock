        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-7-1-21'>
                            <button>7:21 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-22'>
                            <button>7:22 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-23'>
                            <button>7:23 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-24'>
                            <button>7:24 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-25'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 7:22 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 7:22 AM. Set my alarm for 7:22 AM. This free alarm clock will wake you up in time.</p>
