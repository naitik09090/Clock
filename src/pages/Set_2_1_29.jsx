        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-2-1-34'>
                            <button>2:34 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-35'>
                            <button>2:35 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-36'>
                            <button>2:36 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-37'>
                            <button>2:37 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-38'>
                            <button>2:38 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-39'>
                            <button>2:39 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 2:29 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 2:29 AM. Set my alarm for 2:29 AM. This free alarm clock will wake you up in time.</p>
