        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-8-1-48'>
                            <button>8:48 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-49'>
                            <button>8:49 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-50'>
                            <button>8:50 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-51'>
                            <button>8:51 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-52'>
                            <button>8:52 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-53'>
                            <button>8:53 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-54'>
                            <button>8:54 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-55'>
                            <button>8:55 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-56'>
                            <button>8:56 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-57'>
                            <button>8:57 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-58'>
                            <button>8:58 AM</button>{' '}
                        </a>
                        <a href='/Set-8-1-59'>
                            <button>8:59 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 8:55 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 8:55 AM. Set my alarm for 8:55 AM. This free alarm clock will wake you up in time.</p>
