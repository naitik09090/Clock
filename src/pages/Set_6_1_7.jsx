        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-6-1-6'>
                            <button>6:06 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-7'>
                            <button>6:07 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-8'>
                            <button>6:08 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-9'>
                            <button>6:09 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-10'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 6:07 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 6:07 AM. Set my alarm for 6:07 AM. This free alarm clock will wake you up in time.</p>
