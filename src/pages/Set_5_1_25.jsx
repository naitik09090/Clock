        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 5:25 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 5:25 AM. Set my alarm for 5:25 AM. This free alarm clock will wake you up in time.</p>
