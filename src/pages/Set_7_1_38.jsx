        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-7-1-41'>
                            <button>7:41 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-42'>
                            <button>7:42 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-43'>
                            <button>7:43 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-44'>
                            <button>7:44 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-45'>
                            <button>7:45 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-46'>
                            <button>7:46 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-47'>
                            <button>7:47 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-48'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 7:38 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 7:38 AM. Set my alarm for 7:38 AM. This free alarm clock will wake you up in time.</p>
