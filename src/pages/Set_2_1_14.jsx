        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-2-1-13'>
                            <button>2:13 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-14'>
                            <button>2:14 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-15'>
                            <button>2:15 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-16'>
                            <button>2:16 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-17'>
                            <button>2:17 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-18'>
                            <button>2:18 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-19'>
                            <button>2:19 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-20'>
                            <button>2:20 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-21'>
                            <button>2:21 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-22'>
                            <button>2:22 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-23'>
                            <button>2:23 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-24'>
                            <button>2:24 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
                        ...
                        <a href='/Set-2-1-5'>
                            <button>2:05 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-10'>
                            <button>2:10 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-15'>
                            <button>2:15 AM</button>{' '}
                        </a>
                        ...
                        <a href='/Set-2-1-25'>
                            <button>2:25 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-30'>
                            <button>2:30 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-35'>
                            <button>2:35 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-40'>
                            <button>2:40 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-45'>
                            <button>2:45 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-50'>
                            <button>2:50 AM</button>{' '}
                        </a>
                        <a href='/Set-2-1-55'>
                            <button>2:55 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 2:14 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 2:14 AM. Set my alarm for 2:14 AM. This free alarm clock will wake you up in time.</p>
