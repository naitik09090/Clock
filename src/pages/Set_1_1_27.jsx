        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-1-1-26'>
                            <button>1:26 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-27'>
                            <button>1:27 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-28'>
                            <button>1:28 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-29'>
                            <button>1:29 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-30'>
                            <button>1:30 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-31'>
                            <button>1:31 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-32'>
                            <button>1:32 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-33'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 1:27 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 1:27 AM. Set my alarm for 1:27 AM. This free alarm clock will wake you up in time.</p>
