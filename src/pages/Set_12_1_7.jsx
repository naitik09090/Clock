        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-12-1-6'>
                            <button>12:06 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-7'>
                            <button>12:07 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-8'>
                            <button>12:08 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-9'>
                            <button>12:09 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-10'>
                            <button>12:10 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-11'>
                            <button>12:11 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-12'>
                            <button>12:12 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-13'>
                            <button>12:13 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-14'>
                            <button>12:14 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-15'>
                            <button>12:15 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-16'>
                            <button>12:16 AM</button>{' '}
                        </a>
                        <a href='/Set-12-1-17'>
                            <button>12:17 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 12:07 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 12:07 AM. Set my alarm for 12:07 AM. This free alarm clock will wake you up in time.</p>
