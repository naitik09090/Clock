        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-6-1-38'>
                            <button>6:38 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-39'>
                            <button>6:39 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-40'>
                            <button>6:40 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-41'>
                            <button>6:41 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-42'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 6:39 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 6:39 AM. Set my alarm for 6:39 AM. This free alarm clock will wake you up in time.</p>
