        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-1-1-36'>
                            <button>1:36 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-37'>
                            <button>1:37 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-38'>
                            <button>1:38 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-39'>
                            <button>1:39 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-40'>
                            <button>1:40 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-41'>
                            <button>1:41 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-42'>
                            <button>1:42 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-43'>
                            <button>1:43 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-44'>
                            <button>1:44 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-45'>
                            <button>1:45 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-46'>
                            <button>1:46 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-47'>
                            <button>1:47 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 1:37 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 1:37 AM. Set my alarm for 1:37 AM. This free alarm clock will wake you up in time.</p>
