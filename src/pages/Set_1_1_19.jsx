        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-1-1-18'>
                            <button>1:18 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-19'>
                            <button>1:19 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-20'>
                            <button>1:20 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-21'>
                            <button>1:21 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-22'>
                            <button>1:22 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-23'>
                            <button>1:23 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-24'>
                            <button>1:24 AM</button>{' '}
                        </a>
                        <a href='/Set-1-1-25'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 1:19 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 1:19 AM. Set my alarm for 1:19 AM. This free alarm clock will wake you up in time.</p>
