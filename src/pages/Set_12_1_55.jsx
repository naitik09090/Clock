        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-11-1-49'>
                            <button>11:49 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-50'>
                            <button>11:50 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-51'>
                            <button>11:51 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-52'>
                            <button>11:52 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-53'>
                            <button>11:53 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-54'>
                            <button>11:54 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-55'>
                            <button>11:55 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-56'>
                            <button>11:56 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-57'>
                            <button>11:57 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-58'>
                            <button>11:58 AM</button>{' '}
                        </a>
                        <a href='/Set-11-1-59'>
                            <button>11:59 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 11:55 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 11:55 AM. Set my alarm for 11:55 AM. This free alarm clock will wake you up in time.</p>
