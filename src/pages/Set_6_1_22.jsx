        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-6-1-23'>
                            <button>6:23 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-24'>
                            <button>6:24 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-25'>
                            <button>6:25 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-26'>
                            <button>6:26 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-27'>
                            <button>6:27 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-28'>
                            <button>6:28 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-29'>
                            <button>6:29 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-30'>
                            <button>6:30 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-31'>
                            <button>6:31 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-32'>
                            <button>6:32 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 6:22 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 6:22 AM. Set my alarm for 6:22 AM. This free alarm clock will wake you up in time.</p>
