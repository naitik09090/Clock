        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-7-1-26'>
                            <button>7:26 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-27'>
                            <button>7:27 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-28'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 7:27 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 7:27 AM. Set my alarm for 7:27 AM. This free alarm clock will wake you up in time.</p>
