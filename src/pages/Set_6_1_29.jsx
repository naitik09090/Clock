        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-6-1-33'>
                            <button>6:33 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-34'>
                            <button>6:34 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-35'>
                            <button>6:35 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-36'>
                            <button>6:36 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-37'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 6:29 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 6:29 AM. Set my alarm for 6:29 AM. This free alarm clock will wake you up in time.</p>
