        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-7-1-28'>
                            <button>7:28 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-29'>
                            <button>7:29 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-30'>
                            <button>7:30 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-31'>
                            <button>7:31 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-32'>
                            <button>7:32 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-33'>
                            <button>7:33 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-34'>
                            <button>7:34 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-35'>
                            <button>7:35 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-36'>
                            <button>7:36 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-37'>
                            <button>7:37 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-38'>
                            <button>7:38 AM</button>{' '}
                        </a>
                        <a href='/Set-7-1-39'>
                            <button>7:39 AM</button>{' '}
                        </a>
                        <br />
                        <br />
                        <p className='Row_Bottom'></p>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 7:29 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 7:29 AM. Set my alarm for 7:29 AM. This free alarm clock will wake you up in time.</p>
