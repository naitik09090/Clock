        ...
        <div className='container-fluid'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main mb-4'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        ...
                        <a href='/Set-6-1-42'>
                            <button>6:42 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-43'>
                            <button>6:43 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-44'>
                            <button>6:44 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-45'>
                            <button>6:45 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-46'>
                            <button>6:46 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-47'>
                            <button>6:47 AM</button>{' '}
                        </a>
                        <a href='/Set-6-1-48'>
            ...
            <div className='container-fluid'>
                <div className='row Home_Main'>
                    <div className='col-md-12 BTN_Timer2 text-start bg-traslate border'>
                        <h1>Wake me up at 6:43 AM</h1>
                        <div className='Row_Bottom'></div>
                        <p>Set the alarm for 6:43 AM. Set my alarm for 6:43 AM. This free alarm clock will wake you up in time.</p>
